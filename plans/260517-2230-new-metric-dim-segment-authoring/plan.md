...
| Phase | Name | Status |
|-------|------|--------|
| 1 | [Foundation draft V3 types and auto-name](./phase-01-foundation-draft-v3-types-and-auto-name.md) | Pending |
| 2 | [YAML emitter dispatcher per-kind generators](./phase-02-yaml-emitter-dispatcher-per-kind-generators.md) | Pending |
