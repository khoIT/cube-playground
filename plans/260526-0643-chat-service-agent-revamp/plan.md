...
| **02a** | **[Glossary resolution v2 (headline)](./phase-02a-glossary-resolution-v2.md)** | **P0** | **MVP done** (concept tier + resolver short-circuits + flag-gated leaderboard path; sub-phases 02a-D / 02a-FE / 02a-E carry memory merge + FE + 50-case eval) | **`CHAT_GLOSSARY_V2`** |
