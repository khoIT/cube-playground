...
|---|-------|-------|------|--------|
| 04 | [Per-game coverage + eval sweep](phase-04-per-game-coverage-and-eval.md) | 8 games | verify glossary revenue→`revenue_vnd` mapping; run per-game eval subset; record answered-rate delta | not started |
